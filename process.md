...
> 生成时间：2026-08-29 · 最近更新：2026-09-15 · 当前版本：v0.8.1（总览运行任务滚动 + 新建项目建组/自由能成对登记 + INCAR 留空不写/默认 IVDW）
